class User:
    ...
    def __init__(self, userId, userName, email, organizationId, role, isActive, isShared, notes, group, emp_id, promotionCode, subcription
                subscription, emp_id, promotion_code, tags):
        self.userId = userId
